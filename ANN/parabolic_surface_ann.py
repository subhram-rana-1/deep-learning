...
def main():
    ...
    ANN.add(Dense(30, input_dim=2, activation='relu', name='hidden_1'))
    ANN.add(Dense(30, activation='relu', name='hidden_2'))
    ANN.add(Dense(30, activation='relu', name='hidden_3'))
